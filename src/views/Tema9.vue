...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.align-items-center.mb-4
      ...
      .col-lg-auto
        figure(data-aos="fade-left")
          img(src='@/assets/tema9/img-1.svg', alt='Imágen decorativa' style="width:450px").m-auto
    ...
    .titulo-sexto.color-acento-contenido.mb-5(data-aos="fade-rigth")
      p.mb-0 #[b Tabla 3]. Características del código de ética y bioética
    ...
    .row.justify-content-around.align-items-center
      ...
      .col-12.col-lg-auto.justify-content-md-center.mb-4.order-1.order-lg-2.d-none.d-lg-block
