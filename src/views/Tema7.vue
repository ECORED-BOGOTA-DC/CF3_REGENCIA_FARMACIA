    ...
    .row.justify-content-around.flex-d.mb-5
      ...
      .col-5.fond2.esp.p-5
        ...
        ul.lista-ul--color
          li 
            i.ii.fas.fa-atom
            | Por diferentes conocimientos.

          li 
            i.ii.fas.fa-atom
            | Por tener diversas culturas. 

          li 
            i.ii.fas.fa-atom
            | Por los comportamientos organizacionales: 
          li 
            i.ii.fas.fa-atom
            | Su cultura.
      ...
      .col-5.fond2-2.esp.p-5      
        ...
        ul.lista-ul--color.fa-ul2
          li 
            i.fas.fa-atom
            | Por personalidades diferentes (dependientes, independientes, colaboradores, competitivos).
          ...
          li 
            i.fas.fa-atom
            | Por dispares percepciones de las situaciones. 

          li 
            i.fas.fa-atom
            | Por diferente capacidad de creatividad y/o imaginación.
